    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-137.5 max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Adicione um novo momento importante da sua trajetoria de
            aprendizado.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit}>
          <FieldGroup>
                      ...
                      <div className="flex items-center gap-2">
                        <div
                          className={cn(
                            ...
                            colorClasses[cat.color] || "bg-muted",
                          )}
                        />
                        {cat.name}
                      </div>
            ...
            <Field>
              ...
              <div className="flex flex-wrap gap-2 p-3 bg-secondary/50 rounded-lg min-h-15">
                {tags.map((tag) => (
                  <Badge
                    key={tag.id}
                    variant={
                ...
                {tags.length === 0 && (
                  <span className="text-xs text-muted-foreground">
                    Nenhuma tag cadastrada. Crie uma abaixo ou nas
                    configuracoes.
                  </span>
                )}
              </div>
